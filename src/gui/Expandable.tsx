import React, { CSSProperties, KeyboardEvent, MouseEvent, ReactNode, useContext, useState, useTransition } from 'react'

import { ExpandablesContext } from './ExpandablesContext'
...
export default function Expandable({
  ...
  return (
    <span
      className={`${isOpen && useBlockLayoutWhenExpanded ? styles.Block : styles.Inline} ${className}`}
    ...
    >
      ...
      {isOpen ? (
        <span className={`${childrenClassName} ${styles.Children}`} data-test-name="ExpandableChildren">
          {children}
        </span>
      ) : null}
