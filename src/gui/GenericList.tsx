...
export function GenericList<Item, ItemData extends Object>({
  ...
  height: number
  itemData: ItemData
  itemRendererComponent: ComponentType<ListChildComponentProps<GenericListItemData<Item, ItemData>>>
  itemSize: number
  listData: GenericListData<Item>
  ...
  const isLoading = useSyncExternalStore(listData.subscribeToLoading, listData.getIsLoading, listData.getIsLoading)
  const itemCount = useSyncExternalStore(listData.subscribeToInvalidation, listData.getItemCount, listData.getItemCount)
  const selectedItemIndex = useSyncExternalStore(
    listData.subscribeToSelectedIndex,
    listData.getSelectedIndex,
    listData.getSelectedIndex,
  )
  const revision = useSyncExternalStore(listData.subscribeToInvalidation, listData.getRevision, listData.getRevision)
